...
#define hAlpha _ml->template fpfield<16>(_iml)
#define hAlpha_columnindex 16
#define hBeta _ml->template fpfield<17>(_iml)
#define hBeta_columnindex 17
#define Dm _ml->template fpfield<18>(_iml)
#define Dm_columnindex 18
#define Dh _ml->template fpfield<19>(_iml)
  ...
  Datum *_ppvar{};
   _ppvar = nrn_prop_datum_alloc(_mechtype, 4, _prop);
    ...
    assert(_nrn_mechanism_get_num_vars(_prop) == 22);
 	...
 	vshifth = _parm_default[1]; /* 0 */
 	vshiftm = _parm_default[2]; /* 0 */
 	slopeh = _parm_default[3]; /* 6 */
 	slopem = _parm_default[4]; /* 6 */
 	 assert(_nrn_mechanism_get_num_vars(_prop) == 22);
 	_nrn_mechanism_access_dparam(_prop) = _ppvar;
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"hAlpha"} /* 16 */,
                                       _nrn_mechanism_field<double>{"hBeta"} /* 17 */,
                                       _nrn_mechanism_field<double>{"Dm"} /* 18 */,
                                       _nrn_mechanism_field<double>{"Dh"} /* 19 */,
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 NaTg /home/diogo/Dropbox/Diogo/H01_Network_model/cod/GPU_test/Human_L23_NetPyNE-main/sim/mod/NaTg.mod\n");
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/home/diogo/Dropbox/Diogo/H01_Network_model/cod/GPU_test/Human_L23_NetPyNE-main/sim/mod/NaTg.mod";
