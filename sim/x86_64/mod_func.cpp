...
extern "C" void _CaDynamics_reg(void);
extern "C" void _Ca_HVA_reg(void);
extern "C" void _Ca_LVA_reg(void);
extern "C" void _epsp_reg(void);
extern "C" void _Gfluct_reg(void);
extern "C" void _Ih_reg(void);
extern "C" void _Im_reg(void);
extern "C" void _K_P_reg(void);
extern "C" void _K_T_reg(void);
extern "C" void _Kv3_1_reg(void);
extern "C" void _Nap_reg(void);
extern "C" void _NaTg_reg(void);
extern "C" void _NMDA_reg(void);
extern "C" void _ProbAMPANMDA_reg(void);
extern "C" void _ProbUDFsyn_reg(void);
extern "C" void _SK_reg(void);
extern "C" void _tonic_reg(void);
