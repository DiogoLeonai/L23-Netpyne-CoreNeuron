  ...
  Datum *_ppvar{};
   _ppvar = nrn_prop_datum_alloc(_mechtype, 1, _prop);
    ...
    assert(_nrn_mechanism_get_num_vars(_prop) == 10);
 	...
 	g = _parm_default[0]; /* 0.001 */
 	e_gaba = _parm_default[1]; /* -80 */
 	 assert(_nrn_mechanism_get_num_vars(_prop) == 10);
 	_nrn_mechanism_access_dparam(_prop) = _ppvar;
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"e_gaba"} /* 1 */,
                                       _nrn_mechanism_field<double>{"i"} /* 2 */,
                                       _nrn_mechanism_field<double>{"a"} /* 3 */,
                                       _nrn_mechanism_field<double>{"b"} /* 4 */,
                                       _nrn_mechanism_field<double>{"c"} /* 5 */,
                                       _nrn_mechanism_field<double>{"o"} /* 6 */,
                                       _nrn_mechanism_field<double>{"Do"} /* 7 */,
  ...
  hoc_register_dparam_semantics(_mechtype, 0, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 tonic /home/diogo/Dropbox/Diogo/H01_Network_model/cod/GPU_test/Human_L23_NetPyNE-main/sim/mod/tonic.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static const char *modelname = "Tonic GABA current with rectification";
...
/*CVODE*/
 ...
 static int _ode_matsol1 (_internalthreadargsproto_) {
 rates ( _threadargs_ ) ;
 Do = Do  / (1. - dt*( ( a )*( ( ( - 1.0 ) ) ) - ( b )*( 1.0 ) )) ;
  return 0;
}
 /*END CVODE*/
 static int states (_internalthreadargsproto_) { {
   rates ( _threadargs_ ) ;
    o = o + (1. - exp(dt*(( a )*( ( ( - 1.0 ) ) ) - ( b )*( 1.0 ))))*(- ( ( a )*( ( 1.0 ) ) ) / ( ( a )*( ( ( - 1.0 ) ) ) - ( b )*( 1.0 ) ) - o) ;
   }
  return 0;
}
...
static void _hoc_rates(void) {
 ...
 Datum* _ppvar; Datum* _thread; NrnThread* _nt;
  ...
  if(!_prop_id) {
    hoc_execerror("No data for rates_tonic. Requires prior call to setdata_tonic and that the specified mechanism instance still be in existence.", NULL);
  }
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/home/diogo/Dropbox/Diogo/H01_Network_model/cod/GPU_test/Human_L23_NetPyNE-main/sim/mod/tonic.mod";
