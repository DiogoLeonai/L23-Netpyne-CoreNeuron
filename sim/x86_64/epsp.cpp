 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  hoc_register_dparam_semantics(_mechtype, 1, "pntproc");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 epsp /home/diogo/Dropbox/Diogo/H01_Network_model/cod/GPU_test/Human_L23_NetPyNE-main/sim/mod/epsp.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static const char *modelname = "EPSP-like exponential rise and decay current";
...
double curr ( _internalthreadargsprotocomma_ double _lx ) {
   double _lcurr;
 double _ltpeak , _ladjust , _lamp ;
 _ltpeak = tau0 * tau1 * log ( tau0 / tau1 ) / ( tau0 - tau1 ) ;
   _ladjust = 1.0 / ( ( 1.0 - myexp ( _threadargscomma_ - _ltpeak / tau0 ) ) - ( 1.0 - myexp ( _threadargscomma_ - _ltpeak / tau1 ) ) ) ;
   _lamp = _ladjust * imax ;
   if ( _lx < onset ) {
     _lcurr = 0.0 ;
     }
   else {
     _lcurr = - _lamp * ( ( 1.0 - myexp ( _threadargscomma_ - ( _lx - onset ) / tau0 ) ) - ( 1.0 - myexp ( _threadargscomma_ - ( _lx - onset ) / tau1 ) ) ) ;
     }
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/home/diogo/Dropbox/Diogo/H01_Network_model/cod/GPU_test/Human_L23_NetPyNE-main/sim/mod/epsp.mod";
