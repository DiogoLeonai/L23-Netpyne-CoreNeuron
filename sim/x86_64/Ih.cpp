...
#define shift1 _ml->template fpfield<1>(_iml)
#define shift1_columnindex 1
#define shift2 _ml->template fpfield<2>(_iml)
#define shift2_columnindex 2
#define shift3 _ml->template fpfield<3>(_iml)
#define shift3_columnindex 3
#define shift4 _ml->template fpfield<4>(_iml)
#define shift4_columnindex 4
#define shift5 _ml->template fpfield<5>(_iml)
#define shift5_columnindex 5
#define shift6 _ml->template fpfield<6>(_iml)
#define shift6_columnindex 6
#define ihcn _ml->template fpfield<7>(_iml)
...
#define mAlpha _ml->template fpfield<12>(_iml)
#define mAlpha_columnindex 12
#define mBeta _ml->template fpfield<13>(_iml)
  ...
  Datum *_ppvar{};
   _ppvar = nrn_prop_datum_alloc(_mechtype, 1, _prop);
    ...
    assert(_nrn_mechanism_get_num_vars(_prop) == 17);
 	...
 	shift1 = _parm_default[1]; /* 154.9 */
 	shift2 = _parm_default[2]; /* 11.9 */
 	shift3 = _parm_default[3]; /* 0 */
 	shift4 = _parm_default[4]; /* 33.1 */
 	shift5 = _parm_default[5]; /* 6.43 */
 	shift6 = _parm_default[6]; /* 193 */
 	 assert(_nrn_mechanism_get_num_vars(_prop) == 17);
 	_nrn_mechanism_access_dparam(_prop) = _ppvar;
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"shift1"} /* 1 */,
                                       _nrn_mechanism_field<double>{"shift2"} /* 2 */,
                                       _nrn_mechanism_field<double>{"shift3"} /* 3 */,
                                       _nrn_mechanism_field<double>{"shift4"} /* 4 */,
                                       _nrn_mechanism_field<double>{"shift5"} /* 5 */,
                                       _nrn_mechanism_field<double>{"shift6"} /* 6 */,
                                       _nrn_mechanism_field<double>{"ihcn"} /* 7 */,
                                       ...
                                       _nrn_mechanism_field<double>{"mAlpha"} /* 12 */,
                                       _nrn_mechanism_field<double>{"mBeta"} /* 13 */,
  ...
  hoc_register_dparam_semantics(_mechtype, 0, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 Ih /home/diogo/Dropbox/Diogo/H01_Network_model/cod/GPU_test/Human_L23_NetPyNE-main/sim/mod/Ih.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static const char *modelname = "Ih current";
...
static void _hoc_rates(void) {
 ...
 Datum* _ppvar; Datum* _thread; NrnThread* _nt;
  ...
  if(!_prop_id) {
    hoc_execerror("No data for rates_Ih. Requires prior call to setdata_Ih and that the specified mechanism instance still be in existence.", NULL);
  }
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/home/diogo/Dropbox/Diogo/H01_Network_model/cod/GPU_test/Human_L23_NetPyNE-main/sim/mod/Ih.mod";
  ...
  "    Only syntax and numerical robustness were improved.\n"
  "ENDCOMMENT\n"
  "\n"
  "NEURON {\n"
  "    SUFFIX Ih\n"
  ...
  "    UNITSOFF\n"
  "\n"
  "        : Avoid singularities in the rate equations\n"
  "        if (fabs(v + shift1) < 1e-9) {\n"
  "            v = v + 0.0001\n"
  "        }\n"
  "\n"
